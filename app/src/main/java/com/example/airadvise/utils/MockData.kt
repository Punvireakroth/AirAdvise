...
object MockData {
    ...
    fun getMockAirQualityForecasts(): List<AirQualityForecast> {
        return listOf(
            AirQualityForecast(
                id = 1,
                locationId = 1,
                forecastDate = "2023-06-16",
                aqi = 75,
                pm25 = 22.1,
                pm10 = 40.5,
                category = "Moderate",
